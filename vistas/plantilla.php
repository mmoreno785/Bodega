...
<head>
  ...
  <title>Sistema de Control de Bodega</title>
...
<body class="hold-transition skin-blue sidebar-collapse sidebar-mini login-page">
  ...
  if (isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok") {
    ...
    if (isset($_GET["ruta"])) {
      ...
      if (
        ...
        $_GET["ruta"] == "ventas" ||
        $_GET["ruta"] == "vehiculos" ||
        $_GET["ruta"] == "cargar-vehiculo" ||
        $_GET["ruta"] == "descargar-vehiculo" ||
  ...
  <script src="vistas/js/carga.js"></script>
  <script src="vistas/js/descarga.js"></script>
